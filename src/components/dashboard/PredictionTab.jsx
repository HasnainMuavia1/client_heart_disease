...
import { FaSpinner, FaExclamationTriangle, FaHeartbeat, FaChartLine } from "react-icons/fa";

const PredictionTab = ({ reports, reportsLoading, reportsError }) => {
  // Filter reports to only include ECG prediction reports
                    ...
                    <div className="mt-4 p-3 bg-gray-50 rounded-lg border border-gray-200">
                      ...
                      <div className="mt-2">
                        <p className="text-sm">
                          ...
                          <span className={report.ecgPrediction === "Normal" ? "text-green-600 font-medium" : "text-red-600 font-medium"}>
